...
const academicSemester_service_1 = __importDefault(
  require('./academicSemester.service')
);
const createSemester = (0, catchAsync_1.default)(async (req, res) => {
  const { ...data } = req.body;
  const result = await academicSemester_service_1.default.createSemesterInDb(
    data
  );
...
const getAllSemesters = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await academicSemester_service_1.default.getAllSemestersFromDb(
    filters,
    paginationOptions
  );
  (0, sendResponse_1.default)(res, {
...
const getSingleSemester = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result =
    await academicSemester_service_1.default.getSingleSemesterFromDb(id);
  (0, sendResponse_1.default)(res, {
    statusCode: http_status_1.default.OK,
    success: true,
...
const updateSemester = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await academicSemester_service_1.default.updateSemesterFromDb(
    id,
    updatedData
  );
  (0, sendResponse_1.default)(res, {
...
const deleteSemester = (0, catchAsync_1.default)(async (req, res) => {
  const id = req.params.id;
  const result = await academicSemester_service_1.default.deleteSemesterFromDb(
    id
  );
  (0, sendResponse_1.default)(res, {
    statusCode: http_status_1.default.OK,
