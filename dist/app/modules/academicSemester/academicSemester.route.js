...
const academicSemester_controller_1 = __importDefault(
  require('./academicSemester.controller')
);
const academicSemester_validation_1 = __importDefault(
  require('./academicSemester.validation')
);
const router = express_1.default.Router();
router.post(
  '/create_semester',
  (0, validateRequest_1.default)(
    academicSemester_validation_1.default
      .createAcademicSemesterZodValidationSchema
  ),
  academicSemester_controller_1.default.createSemester
);
router.patch(
  '/:id',
  (0, validateRequest_1.default)(
  ...
  academicSemester_controller_1.default.updateSemester
);
