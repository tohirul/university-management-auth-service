...
const academicDepartment_service_1 = __importDefault(require("./academicDepartment.service"));
const createAcademicDepartment = (0, catchAsync_1.default)(async (req, res) => {
    const { ...data } = req.body;
    const result = await academicDepartment_service_1.default.createAcademicDepartmentInDb(data);
...
const getAllAcademicDepartments = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await academicDepartment_service_1.default.getAllAcademicDepartmentsFromDb(filters, paginationOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const getSingleAcademicDepartment = (0, catchAsync_1.default)(async (req, res) => {
    const id = req.params.id;
    const result = await academicDepartment_service_1.default.getSingleDepartmentFromDb(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const updateAcademicDepartment = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await academicDepartment_service_1.default.updateAcademicDepartmentInDb(id, updateData);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const deleteAcademicDepartment = (0, catchAsync_1.default)(async (req, res) => {
    const id = req.params.id;
    const result = await academicDepartment_service_1.default.deleteAcademicDepartmentFromDb(id);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
