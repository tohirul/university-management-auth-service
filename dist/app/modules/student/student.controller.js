...
const getAllStudents = (0, catchAsync_1.default)(async (req, res) => {
    const filters = (0, pick_1.default)(req.query, student_constant_1.StudentDataFilterableFields);
    const paginationOptions = (0, pick_1.default)(req.query, pagination_constants_1.paginationFields);
    const result = await student_service_1.default.getAllStudentFromDb(filters, paginationOptions);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const updateStudent = (0, catchAsync_1.default)(async (req, res) => {
    ...
    const result = await student_service_1.default.updateStudentInDb(id, updatedData);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
