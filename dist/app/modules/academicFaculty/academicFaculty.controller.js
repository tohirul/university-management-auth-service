...
const academicFaculty_service_1 = __importDefault(
  require('./academicFaculty.service')
);
const createFaculty = (0, catchAsync_1.default)(async (req, res) => {
  const { ...createFacultyData } = req.body;
  const result = await academicFaculty_service_1.default.createFacultyInDb(
    createFacultyData
  );
...
const getAllAcademicFaculties = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result =
    await academicFaculty_service_1.default.getAllAcademicFacultiesFromDb(
      filters,
      paginationOptions
    );
  (0, sendResponse_1.default)(res, {
...
const deleteFaculty = (0, catchAsync_1.default)(async (req, res) => {
  const id = req.params.id;
  const result = await academicFaculty_service_1.default.deleteFacultyFromDb(
    id
  );
  (0, sendResponse_1.default)(res, {
    statusCode: http_status_1.default.OK,
...
const updateFaculty = (0, catchAsync_1.default)(async (req, res) => {
  ...
  const result = await academicFaculty_service_1.default.updateFacultyInDb(
    id,
    updateData
  );
  (0, sendResponse_1.default)(res, {
