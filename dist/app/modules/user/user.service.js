...
const createStudentInDb = async (student, userData) => {
  ...
  const academicSemester = await academicSemester_model_1.default.findById(
  ...
  try {
    ...
    userData.id = id;
    student.id = id;
    const createdStudent = await student_model_1.default.create([student], {
      session,
    });
    ...
    const createdUser = await user_model_1.default.create([userData], {
      session,
    });
...
const createFacultyInDb = async (faculty, userData) => {
  ...
  try {
    ...
    userData.id = id;
    faculty.id = id;
    const createdFaculty = await faculty_model_1.default.create([faculty], {
      session,
    });
...
const createAdmin = async (admin, userData) => {
  ...
  try {
    ...
    userData.id = id;
    admin.id = id;
    const createdAdmin = await admin_model_1.default.create([admin], {
      session,
    });
