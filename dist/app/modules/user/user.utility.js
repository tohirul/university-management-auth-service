...
const findLastUserId = async () => {
  const lastUser = await user_model_1.default
    .findOne({}, { id: 1, _id: 0 })
    .sort({
      createdAt: -1,
    })
...
const findLastStrudentId = async () => {
  const lastStudent = await user_model_1.default
...
const findLastFacultyId = async () => {
  const lastFaculty = await user_model_1.default
...
const findLastAdminId = async () => {
  const lastAdmin = await user_model_1.default
