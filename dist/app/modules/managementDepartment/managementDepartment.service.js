...
const managementDepartment_model_1 = __importDefault(
  require('./managementDepartment.model')
);
...
const getAllManagementDepartments = async (filters, options) => {
  ...
  const result = await managementDepartment_model_1.default
...
const updateManagementDepartment = async (id, payload) => {
  ...
  return await managementDepartment_model_1.default.findOneAndUpdate(
    { _id: id },
    payload,
    {
      new: true,
