...
const faculty_route_1 = __importDefault(
  require('../modules/faculty/faculty.route')
);
const managementDepartment_route_1 = __importDefault(
  require('../modules/managementDepartment/managementDepartment.route')
);
