...
const checkInfo = (0, winston_1.createLogger)({
    level: 'info',
    format: combine(label({ label: 'Tohirul' }), timestamp(), custom__format, prettyPrint()),
    transports: [
        new winston_1.transports.Console(),
        new winston_daily_rotate_file_1.default({
            filename: path_1.default.join(process_1.default.cwd(), 'log', 'winston', 'success', 'success-%DATE%.log'),
...
const checkError = (0, winston_1.createLogger)({
    ...
    transports: [
        new winston_1.transports.Console(),
        new winston_daily_rotate_file_1.default({
            filename: path_1.default.join(process_1.default.cwd(), 'log', 'winston', 'error', 'error-%DATE%.log'),
            datePattern: 'YYYY-DD-MM-HH',
            zippedArchive: true,
            maxSize: '20m',
            maxFiles: '5d',
